...
const buttonVariants = cva(
  "group/button select-none inline-flex shrink-0 items-center justify-center bg-clip-padding text-sm font-medium whitespace-nowrap outline-none select-none focus-visible:outline-2 focus-visible:outline-dashed focus-visible:outline-muted focus-visible:outline-offset-1 disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    defaultVariants: {
      size: "default",
      variant: "default",
...
const ButtonWrapper = ({
  ...
  <div
    className={cn(
      ...
      disabled ? "opacity-50 cursor-not-allowed" : "inset-shadow-bevel-thick",
      className,
    )}
  >
    {children}
